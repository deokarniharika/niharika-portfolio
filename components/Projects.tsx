...
const projects: Project[] = [
  {
    ...
    slug: '/projects/internship-management',
  },
  {
    ...
    slug: '/projects/smart-agriculture',
  },
  {
  ...
  },
  {
    ...
    slug: '/projects/football-analytics',
  },
  {
  ...
  },
  {
    ...
    slug: '/projects/epilepsy-detection',
  },
  {
    ...
    slug: '/projects/carbon-footprint',
  },
  {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
            >
              <div className="p-6">
                {/* Tag + Actions */}
